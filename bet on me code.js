document.addEventListener('DOMContentLoaded', () => {
    ...
    millionaireLogo.src = 'millionaire_logo.png';
    ...
    downloadChipBtn.addEventListener('click', () => {
        ...
        a.href = dataURL;
        const userName = userNameInput.value.trim() || 'YourName'; // Use name if available, else fallback
        a.download = `${userName.toLowerCase().replace(/\s/g, '-')}-vegas-chip.png`;
