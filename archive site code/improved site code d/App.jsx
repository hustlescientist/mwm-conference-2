...
import marquettaPhoto from './assets/marquettaspeaking(1).jpeg'
import kingPhoto from './assets/kingphoto.jpg'
                ...
                <Card className="bg-gray-800/50 border-gray-700 hover:border-yellow-400/50 transition-all duration-300 overflow-hidden">
                  <div className="aspect-square overflow-hidden">
                    <img 
                      ...
                      style={{ objectPosition: speaker.name === 'King Jermaine Jones' ? 'center 20%' : 'center center' }}
                    />
                  </div>
                  <CardHeader>
